        ...
        body: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              CustomTextField(obsecureText: false, obsecureText_: (){}, showTrailing: false, hint_text: "New Password", text_controller: controller.passwordController),
              SizedBox(height: 12,),
              Text(
                "Confirm Password",
                style: TextStyle(
              ...
              CustomTextField(obsecureText: false, obsecureText_: (){}, showTrailing: false, hint_text: "Re-enter password", text_controller: controller.confirmPasswordController),
              SizedBox(height: 24,),
              Center(
                    ...
                    if (controller.passwordController.text.isNotEmpty &&
                      ...
                      if (controller.passwordController.text == controller.confirmPasswordController.text) {
                        ...
                        if(response.contains("error message")){
                          Get.snackbar("User Error",response,
                          ...
                          if (responseJson.containsKey("token")) {
                            ...
                            Get.snackbar("User Error",responseJson["error message"],
                              snackPosition: SnackPosition.BOTTOM,
                              backgroundColor: Colors.orange,
                              colorText: Colors.white,
                            );
                        ...
                        Get.snackbar("User Error", "Password Not Matching",
                          snackPosition: SnackPosition.BOTTOM,
                          backgroundColor: Colors.orange,
                          colorText: Colors.white,
                        );
                      ...
                      Get.snackbar("User Error", "Please fill both fields",
                        snackPosition: SnackPosition.BOTTOM,
                        backgroundColor: Colors.orange,
                        colorText: Colors.white,
                      );
